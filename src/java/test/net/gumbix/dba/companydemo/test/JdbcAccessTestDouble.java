...
public class JdbcAccessTestDouble extends JdbcAccess{
	...
	public JdbcAccessTestDouble() throws Exception{
		this("jdbc:hsqldb:mem:mymemdb;sql.syntax_mys=true", "firmenwelt", "firmenwelt10");
	}

	public JdbcAccessTestDouble(String url, String user, String pwd) throws Exception {
        super(url, user, pwd);
        this.setupMockDb();
	}
	...
	private void setupMockDb() throws Exception{
		...
		TestDataGenerator.getInstance(this).createMockData();
	}
